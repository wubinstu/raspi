...
项目名称"慧停车",将树莓派放置于停车位附近,根据距离判定车位是否空闲
...
#或者
$ cd raspi && cmake -B build && cmake --build build && (sudo cmake --install build)
```
### 使用
```text
